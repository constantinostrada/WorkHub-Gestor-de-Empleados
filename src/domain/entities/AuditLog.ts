...
export type AuditAction = 'create' | 'update' | 'delete' | 'vacation.cancelled' | 'employee.offboarded';

export const AUDIT_ACTIONS: readonly AuditAction[] = ['create', 'update', 'delete', 'vacation.cancelled', 'employee.offboarded'] as const;
